        ...
        try {
            ...
            Pair_Code_By_Arslan_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Arslan_Tech.sendMessage(Pair_Code_By_Arslan_Tech.user.id, { text: 'RIJU_XMD_MINI~' + b64data });
...
╔════════════════════◇
║『 YOU'VE CHOSEN RIJU_XMD 』
║ -Set the session ID in WHATSAPP:
║ - SESSION_ID: 
╚════════════════════╝
╔════════════════════◇
║ 『••• _V𝗶𝘀𝗶𝘁 𝗙𝗼𝗿_H𝗲𝗹𝗽 •••』
